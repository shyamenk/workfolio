...
const HeroSection = () => {
  return (
    <div className="relative min-h-[calc(100vh-4rem)] w-full">
        ...
        <div className="col-span-3 flex flex-col items-start justify-center">
          ...
          >
            ...
            <p className="max-w-lg text-lg leading-relaxed text-zinc-200">
              I create modern web applications using the latest technologies. My
              expertise lies in React, Next.js, and full-stack development,
              where I focus on building scalable solutions that address
      ...
      {/* Stats Section */}
      <div className="rounded-md absolute bottom-0 left-0 right-0 border-t border-zinc-800/50 bg-zinc-900/30 backdrop-blur-sm">
